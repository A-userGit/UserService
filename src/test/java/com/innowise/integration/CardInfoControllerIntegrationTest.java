...
public class CardInfoControllerIntegrationTest extends BaseIntegrationTest {
  ...
  public void getByIDTest() {
    try {
      mockMvc.perform(MockMvcRequestBuilders.get("/cards/get/id?id={id}", -1)
  ...
  public void createTest() {
    try {
      CardInfoDto cardInfoDto = new CardInfoDto(0, -1, "4242 4242 4242 4242", "TestH1",
          "11-11-2011");
      ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
      String cardInfoJSON = ow.writeValueAsString(cardInfoDto);
      mockMvc.perform(MockMvcRequestBuilders.post("/cards/create").content(cardInfoJSON)
  ...
  public void updateTest() {
    try {
      ...
      ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
      String cardInfoJSON = ow.writeValueAsString(cardInfoDto);
      mockMvc.perform(MockMvcRequestBuilders.patch("/cards/update").content(cardInfoJSON)
              .contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
  ...
  public void deleteTest() {
    try {
      mockMvc.perform(MockMvcRequestBuilders.delete("/cards/delete").param("id", "-4")
  ...
  public void getByIdsTest() {
    try {
      ...
      mockMvc.perform(MockMvcRequestBuilders.post("/cards/get/multiple").content(idsJSON)
              .contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
